...
_INPUTINFO = _descriptor.Descriptor(
  name='InputInfo',
  full_name='caffe2.InputInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='dims', full_name='caffe2.InputInfo.dims', index=0,
...
_OUTPUTINFO = _descriptor.Descriptor(
  name='OutputInfo',
  full_name='caffe2.OutputInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='labels', full_name='caffe2.OutputInfo.labels', index=0,
      number=1, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MODELMETA = _descriptor.Descriptor(
  name='ModelMeta',
  full_name='caffe2.ModelMeta',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='input', full_name='caffe2.ModelMeta.input', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='output', full_name='caffe2.ModelMeta.output', index=1,
...
_MODELDEF = _descriptor.Descriptor(
  name='ModelDef',
  full_name='caffe2.ModelDef',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='meta', full_name='caffe2.ModelDef.meta', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='init', full_name='caffe2.ModelDef.init', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='predict', full_name='caffe2.ModelDef.predict', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MODELMETA.fields_by_name['input'].message_type = _INPUTINFO
_MODELMETA.fields_by_name['output'].message_type = _OUTPUTINFO
_MODELDEF.fields_by_name['meta'].message_type = _MODELMETA
_MODELDEF.fields_by_name['init'].message_type = _NETDEF
_MODELDEF.fields_by_name['predict'].message_type = _NETDEF
...
class TensorShapes(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
...
class PlanDef(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _PLANDEF
...
class DBReaderProto(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
...
class ModelDef(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
...
_TENSORPROTO.fields_by_name['double_data']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')
...
_QTENSORPROTO.fields_by_name['data']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')
_NETDEF.fields_by_name['num_workers'].has_options = True
_NETDEF.fields_by_name['num_workers']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\030\001')
_EXECUTIONSTEP.fields_by_name['criteria_network'].has_options = True
_EXECUTIONSTEP.fields_by_name['criteria_network']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\030\001')
