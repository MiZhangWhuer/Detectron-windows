...
import pprint
import sys
#caffe2_root = 'G:/Caffe2Design/OurImplementation/BackUPTemp/Caffe2/'
caffe2_root = "G:/Caffe2Design/OurImplementation/src/DeepLearning/"
sys.path.insert(0, caffe2_root)
